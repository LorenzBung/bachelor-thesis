...
Die Kompatibilität wird durch das ROS-Paket \texttt{perception\_pcl} hergestellt, wodurch Punktwolken, Meshes oder andere Datenstrukturen direkt per Message versendet werden können.

Greedy Projection Reconstruction \cite{Marton09ICRA},
