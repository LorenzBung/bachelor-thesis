...
Durch die Veröffentlichung der Microsoft Kinect im Jahr 2010, einer 3D-Kamera, welche ursprünglich für die Nutzung im Entertainment- und Gamingbereich entwickelt worden ist, wurde durch den niedrigen Preis erstmals der breiten Masse der Zugang zu Tiefenkameras ermöglicht \cite[1:55]{kinfuTalkYoutube}.
...
Durch eine schnelle GPU-Implementierung erreicht \ac{KinFu} dabei eine Integration neuer Tiefenbilder bei 30 Hz.
...
Weiterhin ist Chisel eine reine CPU-Implementierung, was die Nutzung auf Mobilgeräten ermöglicht.
...
\begin{figure}[ht]
	\centering
	\subfloat{{\includegraphics[width=0.4\textwidth]{images/yak-reflecting-scene.jpg} }}
	\qquad
	\subfloat{{\includegraphics[width=0.4\textwidth]{images/yak-reflecting-reconstruction.png} }}
