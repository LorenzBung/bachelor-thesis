...
\newtheorem{definition}{Definition}		% Umgebung für Definitionen
\newcommand{\definitionautorefname}{Definition}		% Autoref für Definitionen

\usepackage{algorithm}		% Pseudocode listings
\usepackage{algpseudocode}
\algrenewcommand{\algorithmiccomment}[1]{\hskip3em$//$ #1}	% Kommentarformat
\newcommand{\algorithmautorefname}{Algorithmus}		% Autoref für Pseudocode listings
...
\usepackage{geometry}
\usepackage{tikz}
\usepackage[export]{adjustbox} %outline around images
